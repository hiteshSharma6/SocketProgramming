...
public  class  ChatUsers extends JFrame implements ActionListener {
    ...
    public void buildInterface() {
        ...
        bp.setName("Chat Application Using Socket");
        add(bp,"North");
        send.addActionListener(this);
        exit.addActionListener(this);
        setSize(500,300);
        setVisible(true);
        pack();//for responsive screen
    }
    ...
    public static void main(String[] args) {
        ...
        String setUserName = JOptionPane.showInputDialog(null,"Please enter your name :", "Chat Application",
